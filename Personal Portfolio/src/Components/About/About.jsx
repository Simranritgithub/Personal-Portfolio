  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        <h1 className="text-[60px] md:text-[50px] sm:text-[45px] font-semibold font-sans bg-gradient-to-tr from-[#DF8908] to-[#B415FF] bg-clip-text text-transparent" data-aos="fade-up" data-aos-delay="100">
          About Me
        </h1>
      </div>
      ...
      <div className="flex flex-wrap justify-center items-center gap-20 md:gap-16 sm:gap-10">
        <div className="flex flex-col gap-10 max-w-2xl text-center">
          <div className="flex flex-col gap-2 text-[20px] sm:text-[18px] font-semibold font-[system-ui] text-slate-900 dark:text-gray-100" data-aos="fade-right" data-aos-delay="300" data-aos-duration="1200">
            <p>
          ...
          <div className="flex flex-col gap-5 items-center">
            {abouttechnicalskills.length === 0 ? (
              ...
              abouttechnicalskills.map((skill, index) => (
                ...
                >
                  <p className="min-w-[150px] text-[20px] sm:text-[18px] font-medium text-slate-900 dark:text-gray-100" data-aos="fade-left" data-aos-delay={index*150} data-aos-duration="1200">
                    {skill}
                  </p>
                  <hr
                    className="h-2 rounded-full border-none outline-none bg-gradient-to-r from-[#DF8908] to-[#B415FF]" data-aos="zoom-in" data-aos-delay="500"
